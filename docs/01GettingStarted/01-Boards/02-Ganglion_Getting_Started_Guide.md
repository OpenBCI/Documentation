...
![ECG Arms](assets/GettingStartedImages/ganglion_ECG-arms.png)
...
![Ganglion Switches Differential](assets/GettingStartedImages/ganglion_SW_UP.png)
...
![ECG connection TOP](assets/GettingStartedImages/ganglion_ECG-plugged-top-view.png)
![ECG connection PINS](assets/GettingStartedImages/ganglion_ECG-plugged-pins.png)
...
![channels on/off](assets/GettingStartedImages/ganglion_channels-ON-OFF.jpg)
...
![Ganglion ECG](assets/GettingStartedImages/ganglion_LIVE-ECG.jpg)
...
![Change to Impedance Widget](assets/GettingStartedImages/ganglion_change-widget-to-impedance.jpg)
...
![Measure Impedance](assets/GettingStartedImages/ganglion_ECG-impedance.jpg)
...
![EMG Arms](assets/GettingStartedImages/ganglion_EMG-fist.png)
...
![EMG Signal](assets/GettingStartedImages/ganglion_EMG-signal.jpg)
...
![Switches DOWN](assets/GettingStartedImages/ganglion_SW_DOWN.png)
...
![EEG pin connections](assets/GettingStartedImages/ganglion_EEG-plugged.jpg)
...
![electrode paste scoop](assets/GettingStartedImages/electrodePaste.png)
![Connect REF & D_G paste](assets/GettingStartedImages/ganglion_connect-earlobe-paste.jpg)
![Connect Ref & D_G tape](assets/GettingStartedImages/ganglion_connect-earlobe-tape.jpg)
...
![10-20 map positions](assets/GettingStartedImages/ganglion_10-20-positions.png)
...
![Electrode Frontal Place](assets/GettingStartedImages/ganglion_frontal-place.jpg)
![Electrode Frontal Position](assets/GettingStartedImages/ganglion_frontal-position.jpg)
...
![Electrode Occipital Place](assets/GettingStartedImages/ganglion_occipital-place.jpg)
![Electrode Occipital Position](assets/GettingStartedImages/ganglion_occipital-position.jpg)
...
![Electrodes Banded GtoG](assets/GettingStartedImages/ganglion_electrodes-ready.jpg)

I'm using a headband to help hold the electrodes in place, and now I'm good-to-go! Let's check out some EEG!

![GUI Adjust for EEG](assets/GettingStartedImages/ganglion_vert-scale-50.jpg)

Start the GUI as you have done before, and this time, set the `Vert Scale` to `50uV`.

![Eye Blinks!](assets/GettingStartedImages/ganglion_EEG-eye-blinks.jpg)
...
![Jaw Grits](assets/GettingStartedImages/ganglion_EEG-jaw-grits.jpg)
...
![Alpha!](assets/GettingStartedImages/ganglion_EEG-alpha.jpg)
