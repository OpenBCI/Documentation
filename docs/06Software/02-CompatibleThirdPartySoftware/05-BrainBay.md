...
**MacOS and Linux:** If you have Mac OS or Linux, you can use BrainBay through a virtual machine program like VirtualBox. Check out our VirtualBox tutorial [here!](10Troubleshooting/06-VirtualBox.md)
...
After selecting your device, an EEG window will appear. Select your device's COM port. If you're using VirtualBox, our [VirtualBox tutorial](10Troubleshooting/06-VirtualBox.md) has a section on finding the COM port of a connected hardware device.
