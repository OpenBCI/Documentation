...
4. Connect Button + Photoresistor to Trigger Module with Jumper Cables, as shown below.
:::caution
 *Make sure the pinout lines up with the trigger module. Reverse polarity will damage the system.* 
:::
<div><img src="https://github.com/OpenBCI/Documentation/blob/master/website/docs/assets/CytonImages/Trigger_Kit_Connections.png?raw=true" width="500" /></div>
...
<div style={{textAlign: 'left'}}>
    <img src="https://raw.githubusercontent.com/OpenBCI/Documentation/master/website/docs/assets/CytonImages/D17PushButton.jpg" width="300" />
</div>
