...
You can use both the Cyton and the Ganglion with the OpenBCI GUI to get started with reading your brainwaves. Here is the [tutorial](Software/01-OpenBCISoftware/01-OpenBCI_GUI.md) on installing the OpenBCI GUI.
...
In addition, if you are really comfortable with programming you can use [MatLab](Software/02-CompatibleThirdPartySoftware/01-Matlab.md) or Python tools to analyze the raw data of your OpenBCI boards. For more info, head over to the [For Developers Section](ForDevelopers/00-ForDevelopersLanding.md).
